        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-left nav-menu-left">
                ...
                <li class="dropdown hidden-xs mega-menu">
                    <a href="javascript:" data-toggle="dropdown" class="dropdown-toggle waves-effect waves-light">Mega
                        <b
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                        ...
                                        <p class="text-muted font-13">
                                            Adminox is a fully featured premium admin template built on top of awesome
                                            Bootstrap 3.3.7, modern web technology HTML5, CSS3 and jQuery. It has many
                                            ready to use hand crafted components. The theme is fully responsive and easy
                                            to customize. The code is super easy to understand and gives power to any
                                            developer to turn this theme into real web application.
                                        </p>
                                    </div>
                                    ...
                                    <ul class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a href="javascript:"><i class="fi-help text-muted"></i> Tickets <span
                                    ...
                                    <ul class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a href="javascript:"><i class="fi-mail text-muted"></i> Email <span
                                                        class="badge badge-success">32</span></a>
                                        </li>
                                        <li>
                                    ...
                                    <ul class="col-sm-6 col-md-3 list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a href="javascript:"><i class="fi-marquee-plus text-muted"></i> Extra Pages
                                                <span class="label label-info">22</span></a>
                                        </li>
                                        <li>
                ...
                <li class="dropdown hidden-xs">
                    <a href="javascript:" data-toggle="dropdown" class="dropdown-toggle waves-effect waves-light">
                        Projects <b
                                class=" fa fa-angle-down"></b></a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown user-box">
                    <a href="" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown"
                       aria-expanded="true">
                        <img src="<?php echo $URL_PATH; ?>/assets/images/users/<?php echo md5($_SESSION['Email']); ?>.png" alt="<?php echo $_SESSION['First_Name']; ?> <?php echo $_SESSION['Last_Name']; ?>" class="img-circle user-img">
                    </a>
