                    ...
                    <div class="account-pages">
                        <div class="account-box">
                            ...
                            <div class="account-content">
                                ...
                                <h2 class="text-danger m-t-30">Internal Server Error</h2>
                                <p class="text-muted m-t-30"> Why not try refreshing your page? or you can contact <a
                                            href="<?php echo $URL_PATH; ?>/support" class="text-primary"><b>Support</b></a>
                                </p>
