...
<div id="container" class="ticket-submitted">
    <img src="<?php echo asset_url(); ?>img/logos/mainlogo@1x.png"
         srcset="<?php echo asset_url(); ?>img/logos/mainlogo@1x.png 1x, <?php echo asset_url(); ?>img/logos/mainlogo@2x.png 2x, <?php echo asset_url(); ?>img/logos/mainlogo@3x.png 3x"
         width="270" height="55" title="<?php echo $site_title; ?>"/>
    <?php
    if ($action == 1) {
        ?>
        <div id="central-container" class="clearfix">
            ...
            <form method="POST" action="" name="recover-pass">
                ...
                <input type="text" name="email" id="email" style="font-size:1.3em;" placeholder="Email address..."
                       value="<?php echo $this->input->post('email'); ?>"/>
                <input type="submit" name="submit" class="pull-right" value="Recover password"
    ...
    <?php } elseif ($action == 3) { ?>
        ...
        <div id="central-container" class="clearfix">
            ...
            <form method="POST" action="" name="recover-pass">
                ...
                <input type="password" name="password1" id="password1" style="margin-bottom:18px;"
                       placeholder="New password..." value="<?php echo $this->input->post('password1'); ?>"/>
                <input type="password" name="password2" id="password2" style="margin-top:0px;"
                       placeholder="Password confirmation..." value="<?php echo $this->input->post('password2'); ?>"/>
                <input type="submit" name="submit" class="pull-right" value="Change password"
                       style="width:100%; margin-top:-12px;"/>
            </form>
        </div>
