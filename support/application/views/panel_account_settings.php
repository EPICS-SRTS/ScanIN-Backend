    ...
    <div class="row">
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                <form method="POST" action="<?php echo $base_url; ?>panel/account-settings/basic-settings"
                      name="basic-settings">
                    ...
                    <div class="row no-bottom-margin" style="margin-top:10px;">
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="email_on_tactivity" id="radio_1" class="green"
                                           value="1" <?php if ($user_info->email_on_tactivity == '1') echo 'checked '; ?>/>
                                    <label for="radio_1">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="email_on_tactivity" id="radio_2" class="gray"
                                           value="0" <?php if ($user_info->email_on_tactivity == '0') echo 'checked '; ?>/>
                        ...
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="email_on_bactivity" id="radio_3" class="green"
                                           value="1" <?php if ($user_info->email_on_bactivity == '1') echo 'checked '; ?>/>
                                    <label for="radio_3">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="email_on_bactivity" id="radio_4" class="gray"
                                           value="0" <?php if ($user_info->email_on_bactivity == '0') echo 'checked '; ?>/>
    ...
    <div class="row">
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                <form method="POST" action="<?php echo $base_url; ?>panel/account-settings/change-pp" name="change-pp"
                    ...
                    <div class="row no-bottom-margin">
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                ?>
                                <img src="<?php echo $_2x; ?>"
                                     srcset="<?php echo $_2x; ?> 1x, <?php echo $_2x; ?> 2x, <?php echo $_3x; ?> 3x"
                                     width="90" height="90"/>
                            </div>
                        </div>
                        ...
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="file" style="margin-top:5px;">
                                    <button name="select_profile_picture" class="btn btn-upload-file btn-light-blue">
    ...
    <div class="row">
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                <form method="POST" action="<?php echo $base_url; ?>panel/account-settings/change-password"
