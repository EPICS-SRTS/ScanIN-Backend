        ...
        <div class="col col-xs-12">
            <div class="cont clearfix">
                <div class="top clearfix">
                    <h4 class="pull-left">Ticket details</h4>
                </div>
                ...
                <div class="row min-bottom-margin">
                    <div class="col col-md-6">
                        <div class="form-group">
                            ...
                            <span class="label_desc">Title of your ticket</span>
                        ...
                        <div class="form-group">
                            ...
                            <span class="label_desc">Select a department for your ticket</span>
                    ...
                    <div class="col col-md-6">
                        <div class="form-group">
                            <label for="ticket_msg">Ticket Content</label>
                            <span class="label_desc">Write here the content of your ticket. Please be as explicit as possible</span>
                            <textarea name="ticket_msg" id="ticket_msg"
                                      class="nostyle margin-bottom"><?php if (isset($_POST['ticket_msg'])) echo $_POST['ticket_msg']; ?></textarea>
                        </div>
                ...
                <input type="submit" name="submit" class="btn btn-strong-blue pull-right" value="Send ticket"/>
                </form>
            </div>
        </div>
    </div>
