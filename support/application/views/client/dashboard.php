            ...
            <div class="cont">
                ...
                if ($top_counter['pending_tickets'] == 0)
                    ...
                    <table class="table tickets">
                        <thead>
                        <tr>
                            <th width="5%" data-sort="<?php echo $base_url . 'panel/open-tickets/?type=1sort=1&w=a' ?>">
                                <i class="fa fa-sort"></i>ID
                            </th>
                            <th width="25%"
                                data-sort="<?php echo $base_url . 'panel/open-tickets/?type=1sort=2&w=a' ?>"><i
                                        class="fa fa-sort"></i>Title
                            </th>
                            <th width="12%"
                                data-sort="<?php echo $base_url . 'panel/open-tickets/?type=1sort=3&w=a' ?>"><i
                                        class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Priority
                            </th>
                            <th width="16%"
                                data-sort="<?php echo $base_url . 'panel/open-tickets/?type=1sort=4&w=a' ?>"><i
                                        class="fa fa-sort"></i>Agent
                            </th>
                            <th width="20%"
                                data-sort="<?php echo $base_url . 'panel/open-tickets/?type=1sort=5&w=a' ?>"><i
                                        class="fa fa-sort"></i>Department
                            </th>
                            <th width="22%" data-sort="<?php echo $base_url . 'panel/open-tickets/?type=1sort=6&w=a' ?>"
                                class="md-hide"><i class="fa fa-sort"></i>Last Event
                            </th>
                        </tr>
                        </thead>
            ...
            <div class="cont">
                ...
                if ($top_counter['pending_agent_tickets'] == 0)
                    ...
                    <table class="table tickets">
                        ...
                        <tr>
                            <th width="5%"
                                data-sort="<?php echo $base_url . 'panel/pending-tickets/?type=2sort=1&w=a' ?>"><i
                                        class="fa fa-sort"></i>ID
                            </th>
                            <th width="25%"
                                data-sort="<?php echo $base_url . 'panel/pending-tickets/?type=2sort=2&w=a' ?>"><i
                                        class="fa fa-sort"></i>Title
                            </th>
                            <th width="12%"
                                data-sort="<?php echo $base_url . 'panel/pending-tickets/?type=2sort=3&w=a' ?>"><i
                                        class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Priority
                            </th>
                            <th width="16%"
                                data-sort="<?php echo $base_url . 'panel/pending-tickets/?type=2sort=4&w=a' ?>"><i
                                        class="fa fa-sort"></i>Agent
                            </th>
                            <th width="20%"
                                data-sort="<?php echo $base_url . 'panel/pending-tickets/?type=2sort=5&w=a' ?>"><i
                                        class="fa fa-sort"></i>Department
                            </th>
                            <th width="22%"
                                data-sort="<?php echo $base_url . 'panel/pending-tickets/?type=2sort=6&w=a' ?>"
                                class="md-hide"><i class="fa fa-sort"></i>Last Event
                            </th>
                        </tr>
                        </thead>
            ...
            <div class="cont">
                ...
                if ($top_counter['no_agent_tickets'] == 0)
                    ...
                    <table class="table tickets-w-agent">
                        ...
                        <tr>
                            <th width="12%"
                                data-sort="<?php echo $base_url . 'panel/new-tickets/?type=3&sort=1&w=a' ?>"><i
                                        class="fa fa-sort"></i>ID
                            </th>
                            <th width="24%" data-sort="<?php echo $base_url . 'panel/new-tickets/?type=3sort=2&w=a' ?>">
                                <i class="fa fa-sort"></i>Title
                            </th>
                            <th width="30%" data-sort="<?php echo $base_url . 'panel/new-tickets/?type=3sort=3&w=a' ?>">
                                <i class="fa fa-sort"></i>Department
                            </th>
                            <th width="35%" data-sort="<?php echo $base_url . 'panel/new-tickets/?type=3sort=4&w=a' ?>">
                                <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                            </th>
                        </tr>
                        </thead>
            ...
            <div class="cont">
                ...
                if ($top_counter['solved_tickets'] == 0)
                    ...
                    <table class="table tickets-w-agent">
                        ...
                        <tr>
                            <th width="12%"
                                data-sort="<?php echo $base_url . 'panel/closed-tickets/?type=3&sort=1&w=a' ?>"><i
                                        class="fa fa-sort"></i>ID
                            </th>
                            <th width="24%"
                                data-sort="<?php echo $base_url . 'panel/closed-tickets/?type=3sort=2&w=a' ?>"><i
                                        class="fa fa-sort"></i>Title
                            </th>
                            <th width="30%"
                                data-sort="<?php echo $base_url . 'panel/closed-tickets/?type=3sort=3&w=a' ?>"><i
                                        class="fa fa-sort"></i>Department
                            </th>
                            <th width="35%"
                                data-sort="<?php echo $base_url . 'panel/closed-tickets/?type=3sort=4&w=a' ?>"><i
                                        class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                            </th>
                        </tr>
                        </thead>
            ...
            <div class="cont">
                ...
                if ($top_counter['pending_bugs'] == 0)
                    ...
                    <table class="table bugs">
                        <thead>
                        <tr>
                            <th width="9%" data-sort="<?php echo $base_url . 'panel/all-bugs/?type=1sort=1&w=a' ?>"><i
                                        class="fa fa-sort"></i>ID
                            </th>
                            <th width="28%" data-sort="<?php echo $base_url . 'panel/all-bugs/?type=1sort=2&w=a' ?>"><i
                                        class="fa fa-sort"></i>Title
                            </th>
                            <th width="15%" data-sort="<?php echo $base_url . 'panel/all-bugs/?type=1sort=3&w=a' ?>"><i
                                        class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Priority
                            </th>
                            <th width="23%" data-sort="<?php echo $base_url . 'panel/all-bugs/?type=1sort=4&w=a' ?>"><i
                                        class="fa fa-sort"></i>Department
                            </th>
                            <th width="25%" data-sort="<?php echo $base_url . 'panel/all-bugs/?type=1sort=5&w=a' ?>"
                                class="md-hide"><i class="fa fa-sort"></i>Created On
                            </th>
                        </tr>
                        </thead>
