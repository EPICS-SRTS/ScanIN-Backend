...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700|PT+Sans:400,700|Open+Sans:300,400,600,700,800|Roboto'
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"><img src="<?php echo asset_url(); ?>img/logos/dashlogo@1x.png"
                                         srcset="<?php echo asset_url(); ?>img/logos/dashlogo@1x.png 1x, <?php echo asset_url(); ?>img/logos/dashlogo@2x.png 2x, <?php echo asset_url(); ?>img/logos/dashlogo@3x.png 3x"
                                         width="170" height="25" title="<?php echo $site_title; ?>"/></a>
        </div>
...
<div class="content" id="ticket" data-id="<?php echo $ticket_info->id; ?>"
     data-access="<?php echo $ticket_info->access; ?>">
                    ...
                    <div class="cont">
                        ...
                        <div class="tb-content clearfix">
                            <div class="profile-image">
                                <img src="<?php echo asset_url(); ?>img/profile_img/fa-user@1x.png"
                                     srcset="<?php echo asset_url(); ?>img/profile_img/fa-user@1x.png 1x, <?php echo asset_url(); ?>img/profile_img/fa-user@2x.png 2x, <?php echo asset_url(); ?>img/profile_img/fa-user@3x.png 3x"
                                     width="68" height="68"/>
                            </div>
                            <div class="tb-text">
                                ...
                                if ($ticket_files != false) {
                                    ...
                                    <div class="files-holder clearfix">
                                        ...
                                        foreach ($ticket_files as $file) {
                                            ?>
                                            <a href="<?php echo base_url(); ?>file/1/<?php echo $ticket_info->id; ?>/<?php echo $file[0]; ?>"
                                               class="file clearfix">
                        ...
                        if ($ticket_replies == false)
                            ...
                            foreach ($ticket_replies->result() as $reply) {
                                ...
                                if ($reply->userid == '0' && $reply->agentid == '0') {
                                    ?>
                                    <div class="ticket-message message-right<?php if ($n_ticket_replies == $number_replies_) echo ' last';
                                    if ($number_replies_ == '1') echo ' first'; ?> clearfix">
                                        <div class="text">
                                            <div class="message">
                                    ...
                                    ?>
                                    <div class="ticket-message message-left<?php if ($n_ticket_replies == $number_replies_) echo ' last';
                                    if ($number_replies_ == '1') echo ' first'; ?> clearfix">
                                        <div class="profile-image">
                                            <?php
                ...
                <div class="row min-bottom-margin">
                    <div class="col col-xs-12">
                        <div class="cont clearfix">
                            ...
                            <form method="POST"
                                  action="<?php echo $base_url . 'ticket/' . $ticket_info->access . '/rate' ?>"
                                  enctype="multipart/form-data" name="rating">
                                ...
                                <textarea name="rate_text" id="rate_text"
                                          rows="5"><?php if ($ticket_info->rating_msg != '') echo $ticket_info->rating_msg; ?></textarea>
            ...
            <div class="row min-bottom-margin">
                <div class="col col-xs-12">
                    <div class="cont clearfix">
                        ...
                        <form method="POST"
                              action="<?php echo $base_url . 'ticket/' . $ticket_info->access . '/new-reply' ?>"
                              enctype="multipart/form-data" name="new-reply">
                            <textarea name="reply" id="reply" class="nostyle margin-bottom"></textarea>

                            <div class="upload-files">
                                <div class="file">
                                    <button name="selected_file" class="btn btn-upload-file btn-light-blue">Select file
                                        to upload...
                                    </button>
                                    <button name="delete_file" class="btn btn-upload-file btn-red btn-delete"><i
