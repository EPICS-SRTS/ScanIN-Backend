...
<div id="container" class="create-bug-report">
    ...
    <div id="central-container" class="clearfix">
        ...
        <input type="text" name="subject" id="subject" placeholder="Bug report subject..."
        ...
        if ($allow_files == true) {
            ...
            <div class="upload-files">
                <div class="file">
                    <button name="selected_file" class="btn btn-upload-file btn-light-blue">Select file to upload...
                    </button>
