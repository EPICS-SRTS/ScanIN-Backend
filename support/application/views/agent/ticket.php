                ...
                <div class="col col-xs-12">
                    <div class="cont clearfix">
                        ...
                        <textarea name="reply" id="reply"
                                  class="nostyle margin-bottom"><?php if (isset($textarea_cont)) echo $textarea_cont; ?></textarea>
                        ...
                        <div class="row" style="margin-top:15px; margin-bottom:15px;">
                                ...
                                <div class="cont no-padding no-border">
                                    ...
                                    if ($allow_files == true) {
                                        ...
                                        <div class="upload-files">
                                            <div class="file">
                                                <button name="selected_file" class="btn btn-upload-file btn-light-blue">
                                                    Select file to upload...
                                                </button>
                                                <button name="delete_file"
                                                        class="btn btn-upload-file btn-red btn-delete"><i
                                                            class="fa fa-close"></i></button>
                                                <input type="file" name="files[]" style="display:none;"/>
                                            </div>
                                            <button name="upload_file" class="btn btn-upload-file btn-strong-blue">New
                                                file
                                            </button>
                                        </div>
                                        <?php
                            ...
                            <div class="col col-sm-6" style="margin-top:6px;">
                                <div class="cont no-padding no-border">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="previousPriority"
                                               value="<?php echo $ticket_info->priority; ?>"/>
                                        <select id="changePriority" name="changePriority" class="form-control">
                                            <option value="1"<?php if ($ticket_info->priority == '1') echo ' selected'; ?>>
                                                High
                                            </option>
                                            <option value="2"<?php if ($ticket_info->priority == '2') echo ' selected'; ?>>
                                                Medium
                                            </option>
                                            <option value="3"<?php if ($ticket_info->priority == '3') echo ' selected'; ?>>
                                                Low
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <input type="submit" name="submit-reply" class="btn btn-strong-blue pull-right"
                                       value="Submit reply"/>
                            </div>
                        </div>
                        </form>
