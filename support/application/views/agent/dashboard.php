            ...
            <div class="cont">
                ...
                if ($top_counter['no_agent_tickets'] == 0)
                    ...
                    <table class="table tickets-w-agent">
                        <thead>
                        <tr>
                            <th width="9%" data-sort="<?php echo $base_url . 'panel/tickets/?type=1&sort=1&w=a' ?>"><i
                                        class="fa fa-sort"></i>ID
                            </th>
                            <th width="25%" data-sort="<?php echo $base_url . 'panel/ticket/?type=1sort=2&w=a' ?>"><i
                                        class="fa fa-sort"></i>Title
                            </th>
                            <th width="17%" data-sort="<?php echo $base_url . 'panel/ticket/?type=1sort=3&w=a' ?>"><i
                                        class="fa fa-sort"></i>Client
                            </th>
                            <th width="21%" data-sort="<?php echo $base_url . 'panel/ticket/?type=1sort=4&w=a' ?>"><i
                                        class="fa fa-sort"></i>Department
                            </th>
                            <th width="28%" data-sort="<?php echo $base_url . 'panel/ticket/?type=1sort=5&w=a' ?>"><i
            ...
            <div class="cont">
                ...
                if ($top_counter['pending_tickets'] == 0)
                    ...
                    <table class="table tickets">
                        <thead>
                        <tr>
                            <th width="5%" data-sort="<?php echo $base_url . 'panel/tickets/?type=2sort=1&w=a' ?>"><i
                                        class="fa fa-sort"></i>ID
                            </th>
                            <th width="25%" data-sort="<?php echo $base_url . 'panel/tickets/?type=2sort=2&w=a' ?>"><i
                                        class="fa fa-sort"></i>Title
                            </th>
                            <th width="12%" data-sort="<?php echo $base_url . 'panel/tickets/?type=2sort=3&w=a' ?>"><i
                                        class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Priority
                            </th>
                            <th width="16%" data-sort="<?php echo $base_url . 'panel/tickets/?type=2sort=4&w=a' ?>"><i
                                        class="fa fa-sort"></i>Client
                            </th>
                            <th width="20%" data-sort="<?php echo $base_url . 'panel/tickets/?type=2sort=5&w=a' ?>"><i
                                        class="fa fa-sort"></i>Department
                            </th>
                            <th width="22%" data-sort="<?php echo $base_url . 'panel/tickets/?type=2sort=6&w=a' ?>"
            ...
            <div class="cont">
                ...
                if ($top_counter['pending_bugs'] == 0)
                    ...
                    <table class="table bugs">
                        <thead>
                        <tr>
                            <th width="5%" data-sort="<?php echo $base_url . 'panel/bugs/?type=1sort=1&w=a' ?>"><i
                                        class="fa fa-sort"></i>ID
                            </th>
                            <th width="25%" data-sort="<?php echo $base_url . 'panel/bugs/?type=1sort=2&w=a' ?>"><i
                                        class="fa fa-sort"></i>Title
                            </th>
                            <th width="12%" data-sort="<?php echo $base_url . 'panel/bugs/?type=1sort=3&w=a' ?>"><i
                                        class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Priority
                            </th>
                            <th width="16%" data-sort="<?php echo $base_url . 'panel/bugs/?type=1sort=4&w=a' ?>"><i
                                        class="fa fa-sort"></i>Client
                            </th>
                            <th width="20%" data-sort="<?php echo $base_url . 'panel/bugs/?type=1sort=5&w=a' ?>"><i
                                        class="fa fa-sort"></i>Department
                            </th>
                            <th width="22%" data-sort="<?php echo $base_url . 'panel/bugs/?type=1sort=6&w=a' ?>"
