                                ...
                                if ($bug_files != false) {
                                    ...
                                    <div class="files-holder clearfix">
                                        ...
                                        foreach ($bug_files as $file) {
                                            ?>
                                            <a href="<?php echo base_url(); ?>file/3/<?php echo $bug_info->id; ?>/<?php echo $file[0]; ?>"
                                               class="file clearfix">
            ...
            <div class="row min-bottom-margin">
                <div class="col col-xs-12">
                    <div class="cont clearfix">
                        ...
                        <form method="POST"
                              action="<?php echo $base_url . 'panel/bug/' . $bug_info->access . '/update-bug-status/'; ?>"
                              name="update-bug">
                            <div class="radio">
                                <input type="radio" name="bug_status" id="radio_1" class="green"
                                       value="1"<?php if ($bug_info->status == 3) echo ' checked'; ?> />
                                <label for="radio_1">Mark as solved</label>
                            </div>
                            <div class="radio">
                                <input type="radio" name="bug_status" id="radio_2" class="blue"
                                       value="2"<?php if ($bug_info->status == 4) echo ' checked'; ?> />
                                <label for="radio_2">Mark as reviewed</label>
                            </div>
                            <div class="radio">
                                <input type="radio" name="bug_status" id="radio_3" class="red"
                                       value="3"<?php if ($bug_info->status == 5) echo ' checked'; ?> />
                                <label for="radio_3">Mark as insolvable</label>
                            </div>
                            <div class="radio">
                                <input type="radio" name="bug_status" id="radio_4" class="gray"
                                       value="4"<?php if ($bug_info->status == 6) echo ' checked'; ?> />
                                <label for="radio_4">Other</label>
                            </div>

                            <label>Message to send to the client (optional):</label>
                            <textarea name="reply" id="reply"
                                      class="nostyle margin-bottom"><?php echo $bug_info->agent_msg; ?></textarea>
            ...
            <div class="row min-bottom-margin">
                <div class="col col-xs-12">
                    <div class="cont">
                        ...
                        <form method="POST"
                              action="<?php echo $base_url . 'panel/bug/' . $bug_info->access . '/transfer-bug/'; ?>"
                              name="transfer-bug">
                            <div class="row" style="margin-top:15px; margin-bottom:15px;">
                                ...
                                <div class="col col-sm-6">
                                    <div class="cont no-padding no-border" style="margin-top:-9px;">
                                        <input type="submit" name="transfer" class="btn btn-strong-blue pull-right"
                                               value="Transfer" <?php if ($c == 0) echo 'disabled '; ?>/>
                                    </div>
                                </div>
            ...
            <div class="row min-bottom-margin">
                <div class="col col-xs-12">
                    <div class="cont">
                        ...
                        <form method="POST"
                              action="<?php echo $base_url . 'panel/bug/' . $bug_info->access . '/change-priority/'; ?>"
                              name="transfer-bug">
                            <div class="row" style="margin-top:15px; margin-bottom:15px;">
                                <div class="col col-sm-6" style="margin-bottom:15px;">
                                    <div class="cont no-padding no-border">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="previousPriority"
                                                   value="<?php echo $bug_info->priority; ?>"/>
                                            <select id="changePriority" name="changePriority" class="form-control">
                                                <option value="1"<?php if ($bug_info->priority == '1') echo ' selected'; ?>>
                                                    High
                                                </option>
                                                <option value="2"<?php if ($bug_info->priority == '2') echo ' selected'; ?>>
                                                    Medium
                                                </option>
                                                <option value="3"<?php if ($bug_info->priority == '3') echo ' selected'; ?>>
                                                    Low
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col col-sm-6">
                                    <div class="cont no-padding no-border" style="margin-top:-9px;">
                                        <input type="submit" name="change-priority"
                                               class="btn btn-strong-blue pull-right" value="Change"/>
                                    </div>
                                </div>
