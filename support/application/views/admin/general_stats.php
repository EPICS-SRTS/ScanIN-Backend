            ...
            <div class="cont">
                <div class="head clearfix">
                    ...
                    <div class="pull-right chart_interval">
                        <div class="dropdown">
                            <button class="btn btn-bright-blue btn-dropdown dropdown-toggle" type="button"
                                    id="chartInterval" data-toggle="dropdown" aria-expanded="true">
                                LAST 7 DAYS
                                <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu" data-parentgraph="first_graph" role="menu"
                                aria-labelledby="chartInterval">
                                <li role="presentation" data-graph="last-7-days" data-selected="1"><a role="menuitem"
                                                                                                      tabindex="-1"
                                                                                                      href="#">LAST 7
                                        DAYS</a></li>
                                <li role="presentation" data-graph="this-month" data-selected="0"><a role="menuitem"
                                                                                                     tabindex="-1"
                                                                                                     href="#">THIS
                                        MONTH</a></li>
                                <li role="presentation" data-graph="this-year" data-selected="0"><a role="menuitem"
                                                                                                    tabindex="-1"
                                                                                                    href="#">THIS
                                        YEAR</a></li>
                                <li role="presentation" data-graph="last-5-years" data-selected="0"><a role="menuitem"
                                                                                                       tabindex="-1"
                                                                                                       href="#">LAST 5
                                        YEARS</a></li>
                            </ul>
                ...
                <div class="head clearfix">
                    ...
                    <div class="pull-right chart_interval">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" data-parentgraph="second_graph" role="menu"
                                aria-labelledby="chartInterval">
                                <li role="presentation" data-graph="last-7-days" data-selected="1"><a role="menuitem"
                                                                                                      tabindex="-1"
                                                                                                      href="#">LAST 7
