                ...
                <div class="col col-xs-12">
                    <div class="cont">
                        <div class="top clearfix">
                            ...
                            <div class="btn btn-small btn-blue pull-right" style="margin-left:5px;"
                                 name="edit-department">EDIT
                            </div>
                            <?php
                    ...
                    <div class="cont">
                        ...
                        if ($count_new_tickets == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/new-tickets/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/new-tickets/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/new-tickets/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Client
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/new-tickets/?sort=4&w=a">
                    ...
                    <div class="cont">
                        ...
                        if ($count_pending_tickets == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/pending-tickets/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/pending-tickets/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/pending-tickets/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Client
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/pending-tickets/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                                    </th>
                                </tr>
                                </thead>
                    ...
                    <div class="cont">
                        ...
                        if ($count_open_tickets == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/open-tickets/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/open-tickets/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/open-tickets/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Agent
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/ticket-department/<?php echo $dpt_info->id; ?>/open-tickets/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                                    </th>
                                </tr>
                                </thead>
