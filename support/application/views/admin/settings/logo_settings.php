    ...
    <div class="row">
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                <form method="post" action="<?php echo $base_url; ?>panel/admin/logo-settings/action"
                      enctype="multipart/form-data" name="logo-settings">
                        ...
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="upload-files">
                                    <div class="file">
                                        <button name="selected_file" class="btn btn-upload-file btn-light-blue">Select
                                            file to upload...
                                        </button>
