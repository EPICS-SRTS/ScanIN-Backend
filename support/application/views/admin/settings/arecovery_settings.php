        ...
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                if ($settings->mailing == false)
                    ...
                    ?>
                    <form method="POST" action="<?php echo $base_url; ?>panel/admin/arecovery-settings/action"
                          name="arecovery-settings">
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="allow_account_recovery" id="radio_1" class="green"
                                               value="1" <?php if ($settings->allow_account_recovery == '1') echo 'checked '; ?>/>
                                        <label for="radio_1">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="allow_account_recovery" id="radio_2" class="gray"
                                               value="0" <?php if ($settings->allow_account_recovery == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide1" style="display:none">
                                <div class="from-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="email_recover_type" id="radio_3" class="green"
                                               value="text" <?php if ($settings->email_recover_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_3">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="email_recover_type" id="radio_4" class="green"
                                               value="html" <?php if ($settings->email_recover_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide1" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email_recover_title" id="email_recover_title"
                                               value="<?php echo $settings->email_recover_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="email_recover_content" id="email_recover_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_recover_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="recovery_done" id="radio_5" class="green"
                                               value="1" <?php if ($settings->send_email_recovery_done == '1') echo 'checked '; ?>/>
                                        <label for="radio_5">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="recovery_done" id="radio_6" class="gray"
                                               value="0" <?php if ($settings->send_email_recovery_done == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide2" style="display:none">
                                <div class="from-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="recovery_done_type" id="radio_7" class="green"
                                               value="text" <?php if ($settings->email_recovery_done_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_7">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="recovery_done_type" id="radio_8" class="green"
                                               value="html" <?php if ($settings->email_recovery_done_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide2" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="recovery_done_title" id="recovery_done_title"
                                               value="<?php echo $settings->email_recovery_done_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="recovery_done_content" id="recovery_done_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_recovery_done_content; ?></textarea>
                                </div>
                            </div>
                        </div>
