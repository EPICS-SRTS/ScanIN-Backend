    ...
    <div class="row">
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                <form method="post" action="<?php echo $base_url; ?>panel/admin/general-settings/action"
                    ...
                    <div class="row no-bottom-margin">
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="allow_guest_bug_reports" id="radio_1" class="green"
                                           value="1" <?php if ($settings->allow_guest_bug_reports == '1') echo 'checked '; ?>/>
                                    <label for="radio_1">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="allow_guest_bug_reports" id="radio_2" class="gray"
                                           value="0" <?php if ($settings->allow_guest_bug_reports == '0') echo 'checked'; ?>/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="allow_guest_tickets" id="radio_3" class="green"
                                           value="1" <?php if ($settings->allow_guest_tickets == '1') echo 'checked '; ?>/>
                                    <label for="radio_3">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="allow_guest_tickets" id="radio_4" class="gray"
                                           value="0" <?php if ($settings->allow_guest_tickets == '0') echo 'checked'; ?>/>
                        ...
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="allow_account_creations" id="radio_5" class="green"
                                           value="1" <?php if ($settings->allow_account_creations == '1') echo 'checked '; ?>/>
                                    <label for="radio_5">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="allow_account_creations" id="radio_6" class="gray"
                                           value="0" <?php if ($settings->allow_account_creations == '0') echo 'checked'; ?>/>
                    ...
                    <div class="row min-bottom-margin">
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="allow_guest_file_uploads" id="radio_7" class="green"
                                           value="1" <?php if ($settings->allow_guest_file_uploads == '1') echo 'checked '; ?>/>
                                    <label for="radio_7">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="allow_guest_file_uploads" id="radio_8" class="gray"
                                           value="0" <?php if ($settings->allow_guest_file_uploads == '0') echo 'checked'; ?>/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="file_uploads_max_size" id="file_uploads_max_size"
                                       value="<?php echo $settings->file_uploads_max_size; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="allow_file_uploads" id="radio_9" class="green"
                                           value="1" <?php if ($settings->allow_file_uploads == '1') echo 'checked '; ?>/>
                                    <label for="radio_9">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="allow_file_uploads" id="radio_10" class="gray"
                                           value="0" <?php if ($settings->allow_file_uploads == '0') echo 'checked'; ?>/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="file_uploads_extensions" id="file_uploads_extensions"
                                       value="<?php echo $settings->file_uploads_extensions; ?>"/>
                            </div>
                        </div>
                    </div>
