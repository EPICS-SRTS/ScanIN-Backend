        ...
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                if ($settings->mailing == false)
                    ...
                    ?>
                    <form method="POST" action="<?php echo $base_url; ?>panel/admin/emails-settings/action"
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_ticket_guest" id="radio_1" class="green"
                                               value="1" <?php if ($settings->send_email_ticket_guest_submitted == '1') echo 'checked '; ?>/>
                                        <label for="radio_1">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_ticket_guest" id="radio_2" class="gray"
                                               value="0" <?php if ($settings->send_email_ticket_guest_submitted == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide1" style="display:none">
                                <div class="from-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="ticket_guest_type" id="radio_3" class="green"
                                               value="text" <?php if ($settings->email_ticket_guest_submitted_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_3">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="ticket_guest_type" id="radio_4" class="green"
                                               value="html" <?php if ($settings->email_ticket_guest_submitted_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide1" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ticket_guest_title" id="ticket_guest_title"
                                               value="<?php echo $settings->email_ticket_guest_submitted_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="ticket_guest_content" id="ticket_guest_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_ticket_guest_submitted_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_bug_guest" id="radio_5" class="green"
                                               value="1" <?php if ($settings->send_email_bug_guest_submitted == '1') echo 'checked '; ?>/>
                                        <label for="radio_5">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_bug_guest" id="radio_6" class="gray"
                                               value="0" <?php if ($settings->send_email_bug_guest_submitted == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide2" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="bug_guest_type" id="radio_7" class="green"
                                               value="text" <?php if ($settings->email_bug_guest_submitted_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_7">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="bug_guest_type" id="radio_8" class="green"
                                               value="html" <?php if ($settings->email_bug_guest_submitted_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide2" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="bug_guest_title" id="bug_guest_title"
                                               value="<?php echo $settings->email_bug_guest_submitted_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="bug_guest_content" id="bug_guest_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_bug_guest_submitted_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_new_account" id="radio_9" class="green"
                                               value="1" <?php if ($settings->send_email_new_account == '1') echo 'checked '; ?>/>
                                        <label for="radio_9">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_new_account" id="radio_10" class="gray"
                                               value="0" <?php if ($settings->send_email_new_account == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide3" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="new_account_type" id="radio_11" class="green"
                                               value="text" <?php if ($settings->email_new_account_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_11">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="new_account_type" id="radio_12" class="green"
                                               value="html" <?php if ($settings->email_new_account_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide3" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="new_account_title" id="new_account_title"
                                               value="<?php echo $settings->email_new_account_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="new_account_content" id="new_account_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_new_account_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_new_reply" id="radio_13" class="green"
                                               value="1" <?php if ($settings->send_email_new_reply == '1') echo 'checked '; ?>/>
                                        <label for="radio_13">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_new_reply" id="radio_14" class="gray"
                                               value="0" <?php if ($settings->send_email_new_reply == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide4" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="new_reply_type" id="radio_15" class="green"
                                               value="text" <?php if ($settings->email_new_reply_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_15">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="new_reply_type" id="radio_16" class="green"
                                               value="html" <?php if ($settings->email_new_reply_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide4" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="new_reply_title" id="new_reply_title"
                                               value="<?php echo $settings->email_new_reply_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="new_reply_content" id="new_reply_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_new_reply_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_new_status" id="radio_17" class="green"
                                               value="1" <?php if ($settings->send_email_bug_new_status == '1') echo 'checked '; ?>/>
                                        <label for="radio_17">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_new_status" id="radio_18" class="gray"
                                               value="0" <?php if ($settings->send_email_bug_new_status == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide5" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="new_status_type" id="radio_19" class="green"
                                               value="text" <?php if ($settings->email_bug_new_status_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_19">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="new_status_type" id="radio_20" class="green"
                                               value="html" <?php if ($settings->email_bug_new_status_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide5" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="new_status_title" id="new_status_title"
                                               value="<?php echo $settings->email_bug_new_status_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="new_status_content" id="new_status_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_bug_new_status_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    <label for="radios">Send email to agents when guest has submitted new ticket
                                        (<strong style="color:#FF0000">NEW</strong>)</label>
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_ticket_guest" id="radio_21"
                                               class="green"
                                               value="1" <?php if ($settings->send_agents_email_ticket_guest_submitted == '1') echo 'checked '; ?>/>
                                        <label for="radio_21">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_ticket_guest" id="radio_22"
                                               class="gray"
                                               value="0" <?php if ($settings->send_agents_email_ticket_guest_submitted == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide6" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_ticket_guest_type" id="radio_23"
                                               class="green"
                                               value="text" <?php if ($settings->agents_email_ticket_guest_submitted_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_23">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_ticket_guest_type" id="radio_24"
                                               class="green"
                                               value="html" <?php if ($settings->agents_email_ticket_guest_submitted_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide6" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="agents_new_ticket_guest_title"
                                               id="agents_new_ticket_guest_title"
                                               value="<?php echo $settings->agents_email_ticket_guest_submitted_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="agents_new_ticket_guest_content"
                                              id="agents_new_ticket_guest_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->agents_email_ticket_guest_submitted_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    <label for="radios">Send email to agents when client has submitted new
                                        ticket</label>
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_ticket_client" id="radio_25"
                                               class="green"
                                               value="1" <?php if ($settings->send_agents_email_ticket_client_submitted == '1') echo 'checked '; ?>/>
                                        <label for="radio_25">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_ticket_client" id="radio_26"
                                               class="gray"
                                               value="0" <?php if ($settings->send_agents_email_ticket_client_submitted == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide7" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_ticket_client_type" id="radio_27"
                                               class="green"
                                               value="text" <?php if ($settings->agents_email_ticket_client_submitted_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_27">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_ticket_client_type" id="radio_28"
                                               class="green"
                                               value="html" <?php if ($settings->agents_email_ticket_client_submitted_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide7" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="agents_new_ticket_client_title"
                                               id="agents_new_ticket_client_title"
                                               value="<?php echo $settings->agents_email_ticket_client_submitted_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="agents_new_ticket_client_content"
                                              id="agents_new_ticket_client_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->agents_email_ticket_client_submitted_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    <label for="radios">Send email to agents when guest has submitted new bug
                                        report</label>
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_bug_guest" id="radio_29"
                                               class="green"
                                               value="1" <?php if ($settings->send_agents_email_bug_guest_submitted == '1') echo 'checked '; ?>/>
                                        <label for="radio_29">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_bug_guest" id="radio_30"
                                               class="gray"
                                               value="0" <?php if ($settings->send_agents_email_bug_guest_submitted == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide8" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_bug_guest_type" id="radio_31" class="green"
                                               value="text" <?php if ($settings->agents_email_bug_guest_submitted_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_31">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_bug_guest_type" id="radio_32" class="green"
                                               value="html" <?php if ($settings->agents_email_bug_guest_submitted_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide8" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="agents_new_bug_guest_title"
                                               id="agents_new_bug_guest_title"
                                               value="<?php echo $settings->agents_email_bug_guest_submitted_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="agents_new_bug_guest_content" id="agents_new_bug_guest_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->agents_email_bug_guest_submitted_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    <label for="radios">Send email to agents when client has submitted new bug
                                        report</label>
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_bug_client" id="radio_33"
                                               class="green"
                                               value="1" <?php if ($settings->send_agents_email_bug_client_submitted == '1') echo 'checked '; ?>/>
                                        <label for="radio_33">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_agents_new_bug_client" id="radio_34"
                                               class="gray"
                                               value="0" <?php if ($settings->send_agents_email_bug_client_submitted == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide9" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_bug_client_type" id="radio_35"
                                               class="green"
                                               value="text" <?php if ($settings->agents_email_bug_client_submitted_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_35">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="agents_new_bug_client_type" id="radio_36"
                                               class="green"
                                               value="html" <?php if ($settings->agents_email_bug_client_submitted_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide9" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="agents_new_bug_client_title"
                                               id="agents_new_bug_client_title"
                                               value="<?php echo $settings->agents_email_bug_client_submitted_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="agents_new_bug_client_content" id="agents_new_bug_client_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->agents_email_bug_client_submitted_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="send_email_agent_new_ticket_reply" id="radio_37"
                                               class="green"
                                               value="1" <?php if ($settings->send_agent_email_new_reply == '1') echo 'checked '; ?>/>
                                        <label for="radio_37">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="send_email_agent_new_ticket_reply" id="radio_38"
                                               class="gray"
                                               value="0" <?php if ($settings->send_agent_email_new_reply == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide10" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email. Use HTML to enable bold, italic, etc.</span>
                                    <div class="radio">
                                        <input type="radio" name="agent_new_ticket_reply_type" id="radio_39"
                                               class="green"
                                               value="text" <?php if ($settings->agent_email_new_reply_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_39">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="agent_new_ticket_reply_type" id="radio_40"
                                               class="green"
                                               value="html" <?php if ($settings->agent_email_new_reply_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide10" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <span class="label_desc">Title of the email</span>
                                        <input type="text" name="agent_new_ticket_reply_title"
                                               id="agent_new_ticket_reply_title"
                                               value="<?php echo $settings->agent_email_new_reply_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="agent_new_ticket_reply_content" id="agent_new_ticket_reply_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->agent_email_new_reply_content; ?></textarea>
                                </div>
                            </div>
                        </div>
