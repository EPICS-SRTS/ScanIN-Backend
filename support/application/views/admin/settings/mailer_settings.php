    ...
    <div class="row">
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                <form method="POST" action="<?php echo $base_url; ?>panel/admin/mailer-settings/action"
                    ...
                    <div class="row min-bottom-margin">
                        <div class="col col-md-6">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input type="radio" name="mailing" id="radio_1" class="green"
                                           value="1" <?php if ($settings->mailing == '1') echo 'checked '; ?>/>
                                    <label for="radio_1">Enabled</label>
                                </div>
                                <div class="radio">
                                    <input type="radio" name="mailing" id="radio_2" class="gray"
                                           value="0" <?php if ($settings->mailing == '0') echo 'checked'; ?>/>
                            ...
                            <div class="hide-cont1" style="display:none">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email_from_address" id="email_from_address"
                                           value="<?php echo $settings->email_from_address; ?>"/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email_from_name" id="email_from_name"
                                           value="<?php echo $settings->email_from_name; ?>"/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email_cc" id="email_cc"
                                           value="<?php echo $settings->email_cc; ?>"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col col-md-6">
                            <div class="hide-cont1" style="display:none">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="mailing_method" id="radio_3" class="green"
                                               value="1" <?php if ($settings->mailer_method == '1') echo 'checked '; ?>/>
                                        <label for="radio_3">SMTP</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="mailing_method" id="radio_4" class="green"
                                               value="2" <?php if ($settings->mailer_method == '2') echo 'checked '; ?>/>
                                ...
                                <div class="hide-cont2" style="display:none">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="smtp_timeout" id="smtp_timeout"
                                               value="<?php echo $settings->smtp_timeout; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="hide-cont3" style="display:none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mailpath" id="mailpath"
                                               value="<?php echo $settings->mailpath; ?>"/>
                                    </div>
                                </div>
                            </div>
                        </div>
