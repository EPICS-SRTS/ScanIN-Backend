        ...
        <div class="col col-xs-12">
            <div class="cont clearfix">
                ...
                if ($settings->mailing == false)
                    ...
                    ?>
                    <form method="POST" action="<?php echo $base_url; ?>panel/admin/econfirm-settings/action"
                          name="econfirm-settings">
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="email_confirmation" id="radio_1" class="green"
                                               value="1" <?php if ($settings->email_confirmation == '1') echo 'checked '; ?>/>
                                        <label for="radio_1">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="email_confirmation" id="radio_2" class="gray"
                                               value="0" <?php if ($settings->email_confirmation == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide1" style="display:none">
                                <div class="from-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="n_account_confirmation_type" id="radio_3"
                                               class="green"
                                               value="text" <?php if ($settings->email_new_account_confirmation_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_3">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="n_account_confirmation_type" id="radio_4"
                                               class="green"
                                               value="html" <?php if ($settings->email_new_account_confirmation_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide1" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="n_account_confirmation_title"
                                               id="n_account_confirmation_title"
                                               value="<?php echo $settings->email_new_account_confirmation_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="n_caccount_confirmation_content"
                                              id="n_caccount_confirmation_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_new_account_confirmation_content; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-bottom-margin">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <input type="radio" name="email_confirmed" id="radio_5" class="green"
                                               value="1" <?php if ($settings->send_email_confirmed_account == '1') echo 'checked '; ?>/>
                                        <label for="radio_5">Enabled</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="email_confirmed" id="radio_6" class="gray"
                                               value="0" <?php if ($settings->send_email_confirmed_account == '0') echo 'checked'; ?>/>
                            ...
                            <div class="col col-md-6 toggle-hide2" style="display:none">
                                <div class="from-group">
                                    ...
                                    <span class="label_desc">Type of the email</span>
                                    <div class="radio">
                                        <input type="radio" name="c_account_type" id="radio_7" class="green"
                                               value="text" <?php if ($settings->email_confirmed_account_type == 'text') echo 'checked '; ?>/>
                                        <label for="radio_7">Text</label>
                                    </div>
                                    <div class="radio">
                                        <input type="radio" name="c_account_type" id="radio_8" class="green"
                                               value="html" <?php if ($settings->email_confirmed_account_type == 'html') echo 'checked '; ?>/>
                        ...
                        <div class="row min-bottom-margin toggle-hide2" style="display:none">
                            <div class="col col-md-6">
                                <div class="hide-cont1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_account_title" id="c_account_title"
                                               value="<?php echo $settings->email_confirmed_account_title; ?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="c_account_content" id="c_account_content"
                                              class="nostyle margin-bottom tinyedit"><?php echo $settings->email_confirmed_account_content; ?></textarea>
                                </div>
                            </div>
                        </div>
