                    ...
                    <div class="pull-right">
                            ...
                            <div class="pull-right search">
                                <form method="get" action="" name="search-1">
                                    <input type="text" name="search"
                                           placeholder="Enter search query and press enter" <?php if (isset($_GET['search'])) echo 'value="' . $_GET['search'] . '"'; ?>/>
                                </form>
                            </div>
                            <div class="pull-right">
                                <button class="btn btn-green besides-search" name="drop" data-drop="new-user">New User
                                </button>
                            </div>
                        </div><?php
                        ...
                        <form method="post" action="<?php echo $base_url; ?>panel/admin/new-user" name="new-user">
                            ...
                            <input type="text" name="user-name" placeholder="User name"
                                   value="<?php echo $_POST['user-name']; ?>"/>
                            <br/><br/>
                            ...
                            <div class="radio">
                                <input type="radio" name="user-role" id="user-role1" class="blue"
                                       value="1"<?php if ($_POST['user-role'] == '1') echo ' checked'; ?> />
                                <label for="user-role1">Client</label>
                            </div>
                            <div class="radio">
                                <input type="radio" name="user-role" id="user-role2" class="blue"
                                       value="2"<?php if ($_POST['user-role'] == '2') echo ' checked'; ?> />
                                <label for="user-role2">Agent</label>
                            </div>
                            <div class="radio">
                                <input type="radio" name="user-role" id="user-role3" class="blue"
                                       value="3"<?php if ($_POST['user-role'] == '3') echo ' checked'; ?> />
                ...
                foreach ($all_users->result() as $row) {
                    ...
                    <tr data-href="<?php echo $base_url . 'panel/admin/user/' . $row->id; ?>">
                        ...
                        <td>
                            ...
                            ?>
                            <a href="<?php echo $base_url; ?>panel/admin/user/<?php echo $row->id; ?>/edit"
                               title="Edit user" name="edit-user"><i class="fa fa-pencil"></i></a>
                        </td>
                    </tr>
                    <?php
                }
