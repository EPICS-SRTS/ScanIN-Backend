                ...
                <div class="col col-xs-12">
                    <div class="cont">
                        <div class="top clearfix">
                            ...
                            <div class="btn btn-small btn-blue pull-right" style="margin-left:5px;" name="edit-user">
                                EDIT
                            </div>
                        ...
                        <img src="<?php echo $base_url; ?>assets/img/profile_img/<?php echo $current_user_info->profile_img1x; ?>"
                             srcset="<?php echo $base_url; ?>assets/img/profile_img/<?php echo $current_user_info->profile_img1x; ?> 1x, <?php echo $base_url; ?>assets/img/profile_img/<?php echo $current_user_info->profile_img2x; ?> 2x, <?php echo $base_url; ?>assets/img/profile_img/<?php echo $current_user_info->profile_img3x; ?> 3x"
                             width="68" height="68"/>
                    ...
                    <div class="cont">
                        ...
                        if ($count_last_10_closed_tickets == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/closed-tickets/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/closed-tickets/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/closed-tickets/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Department
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/closed-tickets/?sort=4&w=a">
                    ...
                    <div class="cont">
                        ...
                        if ($count_last_10_solved_bugs == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/solved-bugs/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/solved-bugs/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/solved-bugs/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Department
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/solved-bugs/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                                    </th>
                                </tr>
                                </thead>
                    ...
                    <div class="cont">
                        ...
                        if ($count_last_10_ratings == 0)
                            ...
                            <table class="table ratings">
                                ...
                                <tr>
                                    <th width="28%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/received-ratings/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>Ticket Title
                                    </th>
                                    <th width="28%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/received-ratings/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Ticket Agent
                                    </th>
                                    <th width="14%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/received-ratings/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Rating
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/received-ratings/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                                    </th>
                                </tr>
                                </thead>
