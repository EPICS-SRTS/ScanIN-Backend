            ...
            <div class="row min-bottom-margin">
                <div class="col col-xs-12">
                    <div class="cont clearfix">
                        ...
                        <form method="POST"
                              action="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/edit/action"
                              name="edit-user">
                            <div class="form-group">
                                <label for="user-name">Name</label>
                                <input type="text" name="user-name" id="user-name"
                                       value="<?php echo $current_user_info->name; ?>"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user-email" id="user-email"
                                       value="<?php echo $current_user_info->email; ?>"/>
                            </div>

                            <label id="user-role">Role</label>
                            <div class="radio">
                                <input type="radio" name="user-role" id="user-role2" class="blue"
                                       value="2" <?php if ($current_user_info->role == '2') echo 'checked '; ?>/>
                                <label for="user-role2">Agent</label>
                            </div>
                            <div class="radio">
                                <input type="radio" name="user-role" id="user-role3" class="blue"
                                       value="3" <?php if ($current_user_info->role == '3') echo 'checked '; ?>/>
                            ...
                            <input type="submit" name="save-changes" class="btn btn-strong-blue pull-right"
                                   value="Save changes"/>
                        </form>
                    </div>
                </div>
