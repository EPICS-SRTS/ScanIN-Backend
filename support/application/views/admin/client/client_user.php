                    ...
                    <div class="cont">
                        ...
                        if ($count_last_10_tickets == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/tickets/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/tickets/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/tickets/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Department
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/tickets/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Created On
                                    </th>
                                </tr>
                                </thead>
                    ...
                    <div class="cont">
                        ...
                        if ($count_last_10_bugs == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/bugs/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/bugs/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/bugs/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Client
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/bugs/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Created On
                                    </th>
                                </tr>
                                </thead>
                    ...
                    <div class="cont">
                        ...
                        if ($count_last_10_ratings == 0)
                            ...
                            <table class="table ratings">
                                ...
                                <tr>
                                    <th width="28%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/ratings/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>Ticket Title
                                    </th>
                                    <th width="28%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/ratings/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Ticket Agent
                                    </th>
                                    <th width="14%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/ratings/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Rating
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/user/<?php echo $current_user_info->id; ?>/ratings/?sort=4&w=a">
