                    ...
                    <div class="cont">
                        ...
                        if ($count_free_bugs == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/free-bugs/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/free-bugs/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/free-bugs/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Client
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/free-bugs/?sort=4&w=a">
                    ...
                    <div class="cont">
                        ...
                        if ($count_solved_bugs == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/solved-bugs/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/solved-bugs/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/solved-bugs/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Client
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/solved-bugs/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                                    </th>
                                </tr>
                                </thead>
                    ...
                    <div class="cont">
                        ...
                        if ($count_other_bugs == 0)
                            ...
                            <table class="table tickets-w-agent">
                                ...
                                <tr>
                                    <th width="10%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/other-bugs/?sort=1&w=a">
                                        <i class="fa fa-sort"></i>ID
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/other-bugs/?sort=2&w=a">
                                        <i class="fa fa-sort"></i>Title
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/other-bugs/?sort=3&w=a">
                                        <i class="fa fa-sort"></i>Client
                                    </th>
                                    <th width="30%"
                                        data-sort="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/other-bugs/?sort=4&w=a">
                                        <i class="fa fa-sort hid"></i><i class="fa fa-sort-down"></i>Last Event
                                    </th>
                                </tr>
                                </thead>
