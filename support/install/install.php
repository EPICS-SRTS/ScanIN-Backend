...
<div id="container" class="installation">
    <a href="">
        <img src="../assets/img/logos/mainlogo@1x.png"
             srcset="../assets/img/logos/mainlogo@1x.png 1x, ../assets/img/logos/mainlogo@2x.png 2x, ../assets/img/logos/mainlogo@3x.png 3x"
             width="200" height="45" title="Tickerr" style="margin-top:-50px;"/>
    </a>
        ...
        <form method="POST" action="" name="install">
            ...
            <div class="form-group">
                ...
                <input type="text" id="site_url" name="site_url"
                       value="<?php echo $post->post_value('site_url', $default_base); ?>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="site_title" name="site_title"
                       value="<?php echo $post->post_value('site_title', 'Tickerr - Support System'); ?>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="account_username" name="account_username"
                       value="<?php echo $post->post_value('account_username'); ?>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="account_name" name="account_name"
                       value="<?php echo $post->post_value('account_name'); ?>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="account_email" name="account_email"
                       value="<?php echo $post->post_value('account_email'); ?>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" id="account_pass" name="account_pass"
                       value="<?php echo $post->post_value('account_pass'); ?>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" id="account_rpass" name="account_rpass"
                       value="<?php echo $post->post_value('account_rpass'); ?>"/>
            </div>
            ...
            if ($checker->get_n_result() == 1) {
                ?>
                <div class="warning">
                    As the previous page showed you, some errors were detected. The errors are not critical so you can
                    continue with
                    the installation, but as we said, you need to keep in mind that it goes on your own responsability.
                    Old PHP versions
