<?php use SRTS\Admin\Generator\table;
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Eric O'Keefe has cool shoes</h4>
                ...
                <?php $table->query("SELECT * FROM `Scans` WHERE `EID` = 'e20051289412007614707d5a'"); ?>
                <?php $table->generate(); ?>
